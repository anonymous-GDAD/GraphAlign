...
class MyDataGraphSAINT:
    ...
    def __init__(self, dataset, source_data, target_data, **kwargs):
        if dataset in ["acm", "citation", "dblp", "paper"]:
            ...
            # csr_source_adj = numpy2csr(source_adj)
            # csr_target_adj = numpy2csr(target_adj)
        ...
        self.data_full = MyGraphData(adj_full, feat, labels, idx_train, idx_test)
